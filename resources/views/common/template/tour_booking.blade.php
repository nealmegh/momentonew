...
<div class="booking-history">
    @foreach($tourBookings as $booking)
        ...
        <div class="booking-info clearfix">
            ...
            <h4 class="box-title">
                <a href="{{ url('admin/booking/detail/'.$booking->booking_no) }}"><i class="icon soap-icon-baggage green-color circle"></i>
            ...
            <button class="btn-mini status">{{ $booking->bookingStatus->status_name }}</button>
        </div>

    @endforeach
</div>
<?php echo $tourBookings->render(); ?>
