        ...
        <div id="main" class="md-section">
            <div id="main" class="col-sms-6 col-sm-8 col-md-9">
                ...
                <div class="booking-section travelo-box">
                    ...
                    {!! Form::model($booking, ['url' => 'auth/register', 'method'=>'update']) !!}
                        ...
                        <div class="person-information">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    {!! Form::text('first_name', $booking->guest_>first_name, ['class'=>'input-text full-width']) !!}
                                </div>
                                <div class="col-sm-6 col-md-5">
                                    {!! Form::label('last_name', 'Last Name') !!}
                                    {!! Form::text('last_name', $booking->guest_>last_name, ['class'=>'input-text full-width']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">
                                    {!! Form::label('email', 'Email Address') !!}
                                    {!! Form::email('email', $booking->guest_>email, ['class'=>'input-text full-width']) !!}
                                </div>
                                <div class="col-sm-6 col-md-5">
