        ...
        <tr class="template-download fade">
            <td>
                <span class="preview">
                    {% if (file.thumbnailUrl) { %}
                        <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img src="{%=file.thumbnailUrl%}" width="100px"></a>
                    {% } %}
                </span>
            </td>
            <td>
            ...
            <td>
                {% if (file.deleteUrl) { %}
                    ...
                    <input type="checkbox" name="id" value="{%=file.ImageID%}" class="toggle">
