    ...
    <div class="tab-container full-width-style arrow-left dashboard">
        ...
        <div class="tab-content">
            <div id="dashboard" class="tab-pane fade in active">
                <h1 class="no-margin skin-color">Welcome back to Car Gallery!</h1>
                ...
                <div class="row block">
                    <div class="col-md-12 notifications">
                        ...
                        {!! Form::open(['url'=>'admin/cars/gallery', 'id'=>'fileupload', 'files'=>'true', 'class'=>'gallery']) !!}
                                    ...
                                    <ul class="slides" >
                                        ...
                                        <li style="width: 170px; float: left; display: block;">
                                            <a href="#" class="hover-effect">
                                                ...
                                                <p class="caption">{{$car->title}}</p>
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.cars.gallery.destroy', $image->id], 'class' => 'gallery-thumb']) !!}
