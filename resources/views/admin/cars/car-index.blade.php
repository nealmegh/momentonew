                    ...
                    <div class="col-md-6 notifications">
                        ...
                        <a href="#">
                            <div class="icon-box style1 fourty-space">
                                ...
                                <p class="box-title">Hilton car &amp; resorts in <span class="price">$247</span></p>
                            </div>
                        </a>
                        <a href="#">
                            <div class="icon-box style1 fourty-space">
                        ...
                        <a href="#">
                            <div class="icon-box style1 fourty-space">
                                ...
                                <p class="box-title">Roosevelt car in <span class="price">$170</span></p>
                            </div>
                        </a>
                        <a href="#">
                            <div class="icon-box style1 fourty-space">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <h4 class="box-title">
                                            Hilton Car &amp; Resorts<small>Paris france</small>
                                        </h4>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <h4 class="box-title">
                                            Roosevelt Car<small>new york</small>
                                        </h4>
                                    </a>
                                </li>
                                <li>
