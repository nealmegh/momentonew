<div class="col-md-8">
    ...
    <div class="row form-group">
        ...
        <div class="selector">
            {!! form::select('category_id', ['story'=>'Story', 'page'=>'Page', 'news'=>'News', 'guide'=>'Travel Guide', 'uncategorised' => 'Uncategorised'], null,['class'=>'input-text full-width']) !!}
        </div>
    </div>
    <div class="row form-group">
        {!! form::label('body','Body:') !!}
        {!! form::textarea('body', null, ['class'=>'input-text full-width']) !!}
    </div>
    <div class="row form-group">
