...
@section('content')
        ...
        <div class="banner imagebg-container" style="height: 350px; background-image: url('/images/cars/car-banner.png'); background-size: 100%;">
            <div class="container">
        ...
        <div class="tab-wrapper">
            <div class="tab-container container trans-style">
                <ul class="tabs no-padding">
                    ...
                    <li><a  href="{{ url('cars/booking/complete/'.$booking->booking_no) }}"><i class="soap-icon-shopping-3"></i>Complete Reservation</a></li>
        ...
        <div class="container">
            <div id="main" class="md-section">
                ...
                @include('cars.template.booking._right-sidebar')
            </div>
        </div>
