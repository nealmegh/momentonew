        ...
        <div class="tab-container style1 box">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="hot-hotel-popular">
                    ...
                    {{--<div class="row">--}}
                        {{--<div class="col-xs-2">--}}
                            {{--<a href="#" class="badge-container"><span class="badge-content">save 23%</span><img class="full-width" src="{{ asset('images/hotels/hot-hotel1.png') }}" alt="" width="63" height="59" /></a>--}}
                        {{--</div>--}}
                        {{--<div class="col-xs-8">--}}
