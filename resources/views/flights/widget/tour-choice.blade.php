<h2>Travelers Choice of Tours</h2>
<div class="image-carousel style2 flexslider" data-animation="slide" data-item-width="270" data-item-margin="30">
    <ul class="slides image-box hotel listing-style1">
        <li>
            <article class="box">
                <figure>
                    <a href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img width="270" height="161" alt="" src="{{ asset('images/shortcodes/listings/style01/hotel/1.png') }}"></a>
                </figure>
                <div class="details">
                                        <span class="price">
        ...
        <li>
            <article class="box">
                <figure>
                    <a href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img width="270" height="161" alt="" src="{{ asset('images/shortcodes/listings/style01/hotel/2.png') }}"></a>
                </figure>
                <div class="details">
        ...
        <li>
            <article class="box">
                <figure>
                    <a href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img width="270" height="161" alt="" src="{{ asset('images/shortcodes/listings/style01/hotel/3.png') }}"></a>
                </figure>
                <div class="details">
        ...
        <li>
            <article class="box">
                <figure>
                    <a href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img width="270" height="161" alt="" src="{{ asset('images/shortcodes/listings/style01/hotel/4.png') }}"></a>
                </figure>
                <div class="details">
