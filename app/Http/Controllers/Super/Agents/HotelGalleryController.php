<?php namespace App\Http\Controllers\Super\Agents;
...
class HotelGalleryController extends Controller {
    ...
    function show($hotel_id)
    {
        ...
        return view('agents.hotels.hotel-gallery', compact('hotel', 'images'));
    }
    ...
    public function destroy( $request )
	{
        ...
        return redirect('agents/hotel/gallery/'.$image->imageable_id);
	}
